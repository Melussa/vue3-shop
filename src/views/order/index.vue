  ...
  <div class="page-order">
    ...
    <list-scroll :scroll-data="categoryData" :scrollX="true">
      <section class="order-tag" ref="searchWrap">
        ...
        <span :class="{'active' : orderType===3}" data-type="3" @click="selectTag">待接单(1)</span>
        <span :class="{'active' : orderType===4}" data-type="4" @click="selectTag">待确认(1)</span>
...
<!--        </li>-->
    ...
    <section class="order-card" v-show="orderType==1||orderType ==4">
      <ul class="order-list">
        ...
        <li class="order-btn">
          <router-link to="/order/appeal" tag="span">确认完成</router-link>
        </li>
      </ul>
    </section>
...
<!--        <li class="order-btn">-->
<!--          <router-link to="/order/viewLogistics" tag="span">查看</router-link>-->
